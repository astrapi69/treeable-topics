...
@Configuration
@ComponentScan(basePackages = "de.alpharogroup.treeabletopics")
@EntityScan(basePackages = "de.alpharogroup.treeabletopics.jpa.entity")
@EnableJpaRepositories(basePackages = { "de.alpharogroup.treeabletopics.jpa.repository" })
